            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('/batches/' . $item->id) }}" title="View Batche"><button class="btn btn-info btn-sm">
                                <i class="fa fa-eye" aria-hidden="true"></i> View </button></a>
                            <a href="{{ url('/batches/' . $item->id . '/edit') }}" title="Edit Batch"><button class="btn btn-primary btn-sm">
